...
export const hash = (data: string) => bcrypt.hashSync(password, salt).digest('hex')
...
export const denyAll = () => expressJwt({ secret: '' + window.crypto.getRandomValues(new Uint32Array(1))[0] } as any)
